 ...
 */
export function createTypographyVariables(typography: Record<string, any>): Record<string, string> {
  ...
  function visit(obj: Record<string, any>, path: string[] = []) {
    const isTypographyToken = obj && typeof obj === 'object' && 'fontFamily' in obj;
